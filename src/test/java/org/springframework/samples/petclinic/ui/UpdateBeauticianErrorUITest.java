...
public class UpdateBeauticianErrorUITest {
	...
	public void testUpdateBeauticianSuccessUI() throws Exception {
		...
		Assert.assertEquals("beauticianmodificado f", this.driver.findElement(By.xpath("//b")).getText());
		this.driver.findElement(By.xpath("//body/div/div")).click();
		this.driver.findElement(By.linkText("Edit Beautician")).click();
		...
		this.driver.findElement(By.xpath("//button[@type='submit']")).click();
		Assert.assertEquals("no puede estar vacío", this.driver.findElement(By.xpath("//form[@id='add-beautician-form']/div/div/div/span[2]")).getText());
	}
