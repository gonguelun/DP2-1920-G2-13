...
public class RegisterPickUpRequestNoDescriptionSuccessUITest {
	...
	@Test
	public void testRegisterPickUpRequestNoDescriptionSuccessUITest() throws Exception {
		...
		this.driver.findElement(By.id("physicalStatus")).sendKeys("Esta herido en una oreja");
