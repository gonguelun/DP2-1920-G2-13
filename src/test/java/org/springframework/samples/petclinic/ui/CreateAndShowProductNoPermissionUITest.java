...
public class CreateAndShowProductNoPermissionUITest {
	...
	@Test
	public void testCreateAndShowProductNoPermissionUITest() throws Exception {
		this.driver.get("http://localhost:" + this.port + "/beauticians/{beauticianId}/products/new");
