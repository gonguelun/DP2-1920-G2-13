...
public class ModifyBeautyCenterSuccessUITest {
	...
	public void testModifyBeautyCenterSuccessUITest() throws Exception {
		...
		this.driver.findElement(By.id("description")).sendKeys("hey2");
		...
		Assert.assertEquals("hey2", this.driver.findElement(By.xpath("//table[@id='beautyTable']/tbody/tr/td[2]")).getText());
