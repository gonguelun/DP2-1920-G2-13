...
public class ListPickUpRequestsErrorUITest {
	...
	@Test
	public void testListPickUpRequestsAuthorError() throws Exception {
		this.driver.get("http://localhost:" + this.port);
		this.driver.get("http://localhost:" + this.port + "/vets/pick-up-requests");
