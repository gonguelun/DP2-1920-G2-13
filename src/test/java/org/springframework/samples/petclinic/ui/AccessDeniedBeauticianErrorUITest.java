...
public class AccessDeniedBeauticianErrorUITest {
	...
	@Test
	public void testAccessDeniedBeauticianErrorUITest() throws Exception {
		this.driver.get("http://localhost:" + this.port + "/beauticians/2");
