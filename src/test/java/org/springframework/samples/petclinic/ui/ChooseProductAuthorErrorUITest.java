...
public class ChooseProductAuthorErrorUITest {
	...
	@Test
	public void testChooseProductAuthorError() throws Exception {
		this.driver.get("http://localhost:" + this.port + "/owners/owner1/beauty-centers/1/1/beauty-dates/new");
