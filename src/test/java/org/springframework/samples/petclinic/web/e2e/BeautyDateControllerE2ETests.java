...
public class BeautyDateControllerE2ETests {
	...
	void testInitCreationForm() throws Exception {
		this.mockMvc
			.perform(MockMvcRequestBuilders.get("/owners/{ownerUsername}/beauty-centers/{beautyCenterId}/{petTypeId}/beauty-dates/new", BeautyDateControllerE2ETests.TEST_OWNER_USERNAME, BeautyDateControllerE2ETests.TEST_BEAUTYCENTER_ID,
	...
	void testProcessCreateBeautyDateFormSuccess() throws Exception {
		...
		this.mockMvc
			.perform(MockMvcRequestBuilders
				...
				.with(SecurityMockMvcRequestPostProcessors.csrf()).param("description", "descripcion").param("startDate", "2020/04/29 16:00").param("pet", "currupipi - 1").param("products", "prueba1 - 1"))
	...
	void testBeautyDateNoAuthorForm() throws Exception {
		...
		this.mockMvc.perform(MockMvcRequestBuilders.get("/owners/{ownerUsername}/beauty-dates/{beautyDateId}/edit", "Invalido", BeautyDateControllerE2ETests.TEST_BEAUTYDATE_ID)).andExpect(MockMvcResultMatchers.status().is3xxRedirection())
	...
	void testProcessUpdateBeautyDateFormSuccess() throws Exception {
		this.mockMvc
			.perform(MockMvcRequestBuilders.post("/owners/{ownerUsername}/beauty-dates/{beautyDateId}/edit", BeautyDateControllerE2ETests.TEST_OWNER_USERNAME, BeautyDateControllerE2ETests.TEST_BEAUTYDATE_ID)
				.with(SecurityMockMvcRequestPostProcessors.csrf()).param("description", "modified").param("startDate", "2020/03/31 16:00").param("pet", "currupipi - 1"))
	...
	void testProcessUpdateBeautyDateNoDescriptionFormSuccess() throws Exception {
		this.mockMvc
			.perform(MockMvcRequestBuilders.post("/owners/{ownerUsername}/beauty-dates/{beautyDateId}/edit", BeautyDateControllerE2ETests.TEST_OWNER_USERNAME, BeautyDateControllerE2ETests.TEST_BEAUTYDATE_ID)
				.with(SecurityMockMvcRequestPostProcessors.csrf()).param("description", "").param("startDate", "2020/03/31 16:00").param("pet", "currupipi - 1"))
			.andExpect(MockMvcResultMatchers.status().is3xxRedirection()).andExpect(MockMvcResultMatchers.view().name("redirect:/owners/{ownerUsername}/beauty-dates"));
	}
	...
	void testProcessUpdateBeautyDateEmptyDateFormSuccess() throws Exception {
		this.mockMvc
			.perform(MockMvcRequestBuilders.post("/owners/{ownerUsername}/beauty-dates/{beautyDateId}/edit", BeautyDateControllerE2ETests.TEST_OWNER_USERNAME, BeautyDateControllerE2ETests.TEST_BEAUTYDATE_ID)
				.with(SecurityMockMvcRequestPostProcessors.csrf()).param("description", "").param("pet", "currupipi - 1"))
	...
	void testProcessUpdateBeautyDateWeekendDateFormSuccess() throws Exception {
		...
		this.mockMvc
			.perform(MockMvcRequestBuilders.post("/owners/{ownerUsername}/beauty-dates/{beautyDateId}/edit", BeautyDateControllerE2ETests.TEST_OWNER_USERNAME, BeautyDateControllerE2ETests.TEST_BEAUTYDATE_ID)
				.with(SecurityMockMvcRequestPostProcessors.csrf()).param("description", "modified").param("startDate", "2020/04/18 16:00").param("pet", "currupipi - 1"))
			.andExpect(MockMvcResultMatchers.model().attributeHasErrors("beautyDate")).andExpect(MockMvcResultMatchers.model().attributeHasFieldErrors("beautyDate", "startDate")).andExpect(MockMvcResultMatchers.status().isOk())
			.andExpect(MockMvcResultMatchers.view().name("beauty-dates/createOrUpdateBeautyDateForm"));
	}
	...
	void testProcessUpdateBeautyDateConcurrentDateFormSuccess() throws Exception {
		...
		this.mockMvc
			.perform(MockMvcRequestBuilders.post("/owners/{ownerUsername}/beauty-dates/{beautyDateId}/edit", BeautyDateControllerE2ETests.TEST_OWNER_USERNAME, BeautyDateControllerE2ETests.TEST_BEAUTYDATE_ID)
				.with(SecurityMockMvcRequestPostProcessors.csrf()).param("description", "modified").param("startDate", "2020/04/04 16:00").param("pet", "currupipi - 1"))
			.andExpect(MockMvcResultMatchers.model().attributeHasErrors("beautyDate")).andExpect(MockMvcResultMatchers.model().attributeHasFieldErrors("beautyDate", "startDate")).andExpect(MockMvcResultMatchers.status().isOk())
			.andExpect(MockMvcResultMatchers.view().name("beauty-dates/createOrUpdateBeautyDateForm"));
	}
	...
	void testProcessUpdateBeautyDateIncorrectTimeFormSuccess() throws Exception {
		...
		this.mockMvc
			.perform(MockMvcRequestBuilders.post("/owners/{ownerUsername}/beauty-dates/{beautyDateId}/edit", BeautyDateControllerE2ETests.TEST_OWNER_USERNAME, BeautyDateControllerE2ETests.TEST_BEAUTYDATE_ID)
				.with(SecurityMockMvcRequestPostProcessors.csrf()).param("description", "modified").param("startDate", "2020/04/29 22:00").param("pet", "currupipi - 1"))
			.andExpect(MockMvcResultMatchers.model().attributeHasErrors("beautyDate")).andExpect(MockMvcResultMatchers.model().attributeHasFieldErrors("beautyDate", "startDate")).andExpect(MockMvcResultMatchers.status().isOk())
			.andExpect(MockMvcResultMatchers.view().name("beauty-dates/createOrUpdateBeautyDateForm"));
	}
	...
	void testProcessUpdateBeautyDateEmptyPetFormSuccess() throws Exception {
		...
		this.mockMvc
			.perform(MockMvcRequestBuilders.post("/owners/{ownerUsername}/beauty-dates/{beautyDateId}/edit", BeautyDateControllerE2ETests.TEST_OWNER_USERNAME, BeautyDateControllerE2ETests.TEST_BEAUTYDATE_ID)
				.with(SecurityMockMvcRequestPostProcessors.csrf()).param("description", "modified").param("startDate", "2020-04-29 16:00").param("pet", "null"))
